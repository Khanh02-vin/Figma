...
import { ArrowLeft, ChevronRight, Wifi, Headphones, Globe } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex items-center px-4 py-4">
        ...
        <h1 className="flex-1 text-xl font-bold text-center mr-10">Contact Support</h1>
      </div>
      ...
      <div className="flex-1 px-4 overflow-auto space-y-3">
        {contacts.map((contact) => (
          ...
          >
            {contact.icon}
            <span className="flex-1 font-semibold text-foreground text-left">{contact.name}</span>
